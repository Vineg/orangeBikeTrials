 ...
 * <p>
 * An unspecified behavior will be caused if the {@code playerId} parameter
...
public class ActionEvent {
    ...
    /**
     * This event playerId indicates that a meaningful action occured.
     */
