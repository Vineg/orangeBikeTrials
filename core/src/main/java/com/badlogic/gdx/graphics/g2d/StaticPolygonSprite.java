 ...
 * @author Nathan Sweet */
public class StaticPolygonSprite {
	...
	public StaticPolygonSprite (PolygonRegion region) {
		setRegion(region);
		setColor(1, 1, 1, 1);
	...
	public StaticPolygonSprite (StaticPolygonSprite sprite) {
		set(sprite);
	}

	public void set (StaticPolygonSprite sprite) {
	...
	public void draw (StaticPolygonSpriteBatch spriteBatch) {
		final PolygonRegion region = this.region;
		spriteBatch.draw(region.region.texture, getVertices(), 0, vertices.length, region.triangles, 0, region.triangles.length);
	}

	public void draw (StaticPolygonSpriteBatch spriteBatch, float alphaModulation) {
