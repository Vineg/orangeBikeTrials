 ...
 * Besides sparse allocations to increase the bodySize of the internal Array, {@link org.andengine.util.adt.list.ShiftList} is allocation free (unlike the {@link java.util.LinkedList} family).
 * 
