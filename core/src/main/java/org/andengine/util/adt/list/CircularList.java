 ...
 * Besides sparse allocations to increase the bodySize of the internal Array, {@link org.andengine.util.adt.list.CircularList} is allocation free (unlike the {@link java.util.LinkedList} family).
 *
 * (c) Zynga 2012
 *
 * @author Greg Haynes
